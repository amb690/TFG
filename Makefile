CC=			icc
#CC=			clang --analyze
CFLAGS=		-mmic -g -Wall -Wno-unused-function -O2 -I/home/zlib/include
WRAP_MALLOC=-DUSE_MALLOC_WRAPPERS
AR=			ar
DFLAGS=		-DHAVE_PTHREAD $(WRAP_MALLOC)
LOBJS=		utils.o kthread.o kstring.o bwt.o bntseq.o bwa.o bwamem.o bwamem_pair.o bwamem_extra.o malloc_wrap.o \
			QSufSort.o bwt_gen.o rope.o rle.o is.o bwtindex.o
AOBJS=		bwashm.o bwase.o bwaseqio.o bwtgap.o bwtaln.o bamlite.o \
			bwape.o kopen.o pemerge.o maxk.o \
			bwtsw2_core.o bwtsw2_main.o bwtsw2_aux.o bwt_lite.o \
			bwtsw2_chain.o fastmap.o bwtsw2_pair.o ksw.o
PROG=		bwa
INCLUDES=	
...
bwa:libbwa.a $(AOBJS) main.o
		$(CC) $(CFLAGS) $(DFLAGS) IGP_library.c $(AOBJS) main.o -o $@ -Wl,-rpath,/opt/intel/composer_xe_2015.7.235/compiler/lib/mic -L. -lbwa $(LIBS)
